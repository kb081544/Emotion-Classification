...
x_train, x_test, y_train, y_test, gmm_p, gmm_n = train_filtered.GMM_model(data=train_filtered, tot="train")
...
x_test, y_test = test_filtered.GMM_model(data=test_filtered, tot="test", gmm_p=gmm_p, gmm_n=gmm_n)
print(x_test)
print(y_test)
